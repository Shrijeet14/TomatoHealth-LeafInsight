...
# filepath = r'D:\HACKATHONS\App_A_Thon\Plant_disease\Plant-Leaf-Disease-Prediction\model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        # file_path = os.path.join('D:\HACKATHONS\App_A_Thon\Plant_disease\Plant-Leaf-Disease-Prediction\static\upload', filename)
        # import os

        # file_path = os.path.join(r'D:\HACKATHONS\App_A_Thon\Plant_disease\Plant-Leaf-Disease-Prediction\static\upload', filename)
